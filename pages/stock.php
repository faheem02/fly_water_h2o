...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_product'])) {
    ...
    $insert_query = "INSERT INTO products (product_name, sale_price, current_stock, track_empty_bottles, status, created_datetime) 
                     VALUES ('$product_name', $sale_price, $opening_stock, $track_empty, 'Active', '$datetime')";
                                ...
                                <tr class="<?php echo $is_low ? 'low-stock' : ''; ?>">
                                    ...
                                    <td class="text-center">
                                        <?php if(!empty($p['track_empty_bottles'])): ?>
                                            <span class="badge bg-success" title="Empty bottle stock is tracked for this product">Yes</span>
                                        <?php else: ?>
                                            <span class="badge bg-secondary" title="No empty bottle stock tracking for this product">No</span>
                                        <?php endif; ?>
                                    </td>
