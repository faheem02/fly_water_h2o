...
$result = mysqli_query($conn, "SELECT supplier_code, supplier_name, mobile, address FROM suppliers WHERE status='Active' ORDER BY supplier_code ASC");
?>
...
<div class="print-header no-print">
    <h5><i class="fas fa-truck me-2"></i> Supplier ID List</h5>
...
<div class="print-area">
    ...
    <table class="list-table" id="listTable">
        ...
        <tbody>
            ...
            <tr>
                <td class="id-col"><?php echo htmlspecialchars($row['supplier_code']); ?></td>
    ...
    <?php else: ?>
        <p class="empty-msg">No active suppliers found.</p>
    <?php endif; ?>
</div>
