...
$result = mysqli_query($conn, "SELECT customer_code, customer_name, mobile, address FROM customers WHERE status='Active' ORDER BY customer_code ASC");
?>
...
<div class="print-header no-print">
    <h5><i class="fas fa-id-card me-2"></i> Customer ID List</h5>
    <div class="d-flex align-items-center gap-3">
        <input type="text" class="search-box" id="searchInput" placeholder="Search by ID, name, phone..." oninput="filterTable()">
...
<div class="print-area">
    ...
    <table class="list-table" id="listTable">
        ...
        <tbody>
            ...
            <tr>
                <td class="id-col"><?php echo htmlspecialchars($row['customer_code']); ?></td>
    ...
    <?php else: ?>
        <p class="empty-msg">No active customers found.</p>
    <?php endif; ?>
</div>
