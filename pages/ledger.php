...
if ($customer_id) {
    $cust = mysqli_fetch_assoc(mysqli_query($conn, "SELECT customer_name, mobile, address, outstanding_balance, empty_bottles_balance, security_deposit FROM customers c WHERE id=$customer_id $salesman_where"));
    if($cust) {
        ...
        if($from_date && $to_date) {
            ...
            $date_condition = "AND DATE(wl.transaction_date) >= '$from_date'";
        } elseif($to_date) {
